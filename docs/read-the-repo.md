...
2. `docs/current-baseline.md`
   ...
   Read the current known-good and first-known-bad stage before debugging. This
   keeps iteration grounded in a named baseline instead of a vague build state.

3. `docs/read-the-repo.md`
...
8. `TinyStories/model_adapter_representative_core_pt2e_static_quant.py`
