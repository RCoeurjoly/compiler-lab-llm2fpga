"builtin.module"() ({
  ...
  ^bb0(%arg0: i64):
    %0 = "memref.alloc"() <{alignment = 64 : i64, operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<64xi64>
    %1 = "memref.alloc"() <{alignment = 64 : i64, operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<64xi64>
    %2 = "arith.constant"() <{value = 63 : index}> : () -> index
    "memref.store"(%arg0, %0, %2) : (i64, memref<64xi64>, index) -> ()
    ...
    ^bb0(%arg1: index):
      ...
      %11 = "memref.load"(%0, %8) : (memref<64xi64>, index) -> i64
      "memref.store"(%11, %1, %10) : (i64, memref<64xi64>, index) -> ()
      "scf.yield"() : () -> ()
    }) : (index, index, index) -> ()
    %6 = "memref.load"(%1, %2) : (memref<64xi64>, index) -> i64
    "func.return"(%6) : (i64) -> ()
  }) : () -> ()
}) : () -> ()
